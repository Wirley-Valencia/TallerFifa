...
class RegisterForm(forms.Form):
    ...
    email = forms.EmailField(max_length=254, required=True,  widget=forms.EmailInput(attrs={'class':'form-control','id': 'email'}))
    password = forms.CharField(required=True, widget=forms.PasswordInput(attrs={'class':'form-control','id': 'password'}))
    password2 = forms.CharField(required=True,label='confirmar password', widget=forms.PasswordInput(attrs={'class':'form-control'}))
